...
export default function ProductsListingPage(props) {
  ...
  const { products, filters, total } = useSelector((state) => state.products);
  ...
  return (
    <div className="container product-page-wraper">
      {(products?.length > 0 || !props.loadedFromSearch || isFilterApplied) && (
        <div>
          <section>
            <div className="product-header-section">
              ...
              <div className="filter-section">
                <div className="seven columns listing-header">
                  {category ? category : "All Products"}({total})
                </div>
