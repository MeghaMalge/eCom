...
function ProductInfo({ product }) {
  ...
  return (
    <>
      <div className='bookmark'><h5>{product.category}</h5><BookMark /></div>
      <h3>{product.title}</h3>
      <Divider />
      <div className="price-wrapper">
        <DiscountedPrice originalPrice={product.price} discount={product.discountPercentage} />
      ...
      <div className="actions">
        ...
        <Button ariaLabel="Express Checkout" onClickHandler={() => navigate("/cart")}>Express Checkout</Button>
      </div>
      <div className="shipping-methods">
        ...
        <ShippingMethod
          ...
          id="FreePickup"
          address="TUMI at Perimeter Mall"
