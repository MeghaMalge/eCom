          ...
          <div className="d-flex align-items-center">
                ...
                <ul className="header-menu-nav">
                  <li className="header-menu-nav-links">
                    <LinkTo
                      ...
                      to={`/products`}
                      className={`darkMode-focus ${splitLocation[2] === "products" ? "active" : ""
                        }`}
                      id="products"
                    >
                      All Products
                        ...
                        {index < showCategories && (
                          <li className="header-menu-nav-links">
                            <LinkTo
                              ...
                              className={`darkMode-focus ${splitLocation[2] === category.toLowerCase()
                                ? "active"
                                : ""
                                }`}
                              id={category}
            ...
            <div className="ml-auto header-icons d-flex">
              <ul>
                ...
                <li>
                  <Button onClickHandler={() => { navigate('cart') }}>
                    <CartIcon />
                  </Button>
                </li>
                <li className="hamburger-icon">
                  <Button
                    ...
                    type="submit"
                    className={`header-menu-toggle ${isToggleMenuActive ? "active" : ""
                      }
                    `}
