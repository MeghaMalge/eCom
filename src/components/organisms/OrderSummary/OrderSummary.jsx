  ...
  function applyPromo(promoCodeValue) {
    if (promoCodeValue) {
      if (promoCodeValue.toLocaleUpperCase() === "FLAT50") {
        ...
        setPromo(5)
        setPromoCodeError("Sorry Promo code is Invaild applying default 5$ off")
      }
    }
  }
  return (
      ...
      <div className="order-summary-padding">
          ...
          <>
            ...
            <div className="order-summary">
              ...
              <div className="apply-button">
                <Button className="promo-button" dataTestId="Apply" onClickHandler={() => applyPromo(promoCode)}>Apply</Button>
              </div>
            </div>
        ...
        {pageType !== "orderConfirmation" &&
          <div className="tumi-member">
            <p className="tumi-member__message">Become a TUMI Member for faster checkout</p>
        ...
        {cartPage === "cart" &&
          <div className="button-center">
            <Button disabled={data <= 0 ? true : false} className="checkout fill" dataTestId="CheckoutNow" onClickHandler={() => checkoutOrder()}>Checkout Now</Button>
            <Button disabled={data <= 0 ? true : false} className="checkout-apple" dataTestId="CheckOutApplePay">
              <span className="fa-text">Check out with</span>{" "}
              <span className="fa-apple">
                <FaApplePay></FaApplePay>
              </span>
            </Button>
            <Button disabled={data <= 0 ? true : false} className="checkout-paypal" dataTestId="CheckOutPaypal">
